        ...
        <div
          ...
          <div className="container">
            <div className="widget-text text-center">
              <h3 className="widget-title small lt-sp06 mg-b63 text-white">
                Stay Connected
              </h3>
              <p className="address mg-b2 text-white">Lagos, Nigeria</p>
              <p className="email mg-b5 text-white">easyclick05@gmail.com</p>
              <p className="phone mg-b53 text-white">+2348067177670</p>
              <div className="site-list site-list-center">
                <Link to="#" className="bg-s1">
                  <i className="fa fa-twitter" aria-hidden="true" />
                </Link>
                <Link to="#" className="bg-s4">
